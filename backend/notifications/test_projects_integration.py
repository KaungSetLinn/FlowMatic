...
class ProjectsNotificationIntegrationTest(APITestCase):
    ...
    def test_project_put_update_sends_notifications(self):
        ...
        response = self.client.put(project_url, update_data, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_multiple_project_updates_create_multiple_notifications(self):
        ...
        # 1回目の更新
        self.client.patch(project_url, {"title": "1回目更新"}, format="json")

        # 2回目の更新
        self.client.patch(project_url, {"title": "2回目更新"}, format="json")

        # 3回目の更新
        self.client.patch(project_url, {"title": "3回目更新"}, format="json")
    ...
    def test_project_update_related_object_id(self):
        ...
        # プロジェクトを更新
        self.client.force_authenticate(user=self.user1)
        self.client.patch(project_url, {"title": "更新後"}, format="json")
